    ...
    $.fn.extend({
        smoothSlides: function(options) {
            ...
            var options = $.extend(defaults, options),
                convertSeconds = (options.duration / 1000) - 5  //Assuming 10s
            ...
            if (options.autoPlay == 'true') {
                if ($('.ss-slide:last').children('content')) {
                    var caption = $('.ss-slide:last').children('content').html();
                    $('.ss-caption').html(caption);
                }
            } else {
                if ($('.ss-slide:first').children('content')) {
                    var caption = $('.ss-slide:first').children('content').html();
                    $('.ss-caption').html(caption);
                } else {
                    $('.ss-caption').hide();
                }
            ...
            function captionUpdater() {
                if ($('.ss-slide:eq(-2)').children('content')) {
                    var caption = $('.ss-slide:eq(-2)').children('content').html();
